...
isLoggedIn = username === "admin@gmail.com" && password === "admin";
      ...
      {isLoggedIn && (
        <Layout>
          <Switch>
            ...
            />
            <PrivateRoute
              path="/students-by-age"
              exact
              component={StudentsByAge}
            />
            <PrivateRoute
            ...
            />
            <PrivateRoute
              path="/teachers-by-subject"
              exact
              component={TeachersBySubject}
            />
            ...
            />
            <PrivateRoute
              path="/teachers-by-salary"
              exact
              component={TeachersBySalary}
            />
